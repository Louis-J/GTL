...
constexpr auto retLbdCase(X x) {
    ...
    if constexpr (N == 2) {
        ...
        constexpr auto cmpl = retLbdCase<shs, N/2>(x);
        constexpr auto cmpr = retLbdCase<shs + N/2, N - N/2>(x);
        auto ret = [=](int val) ->TypeD {
...
const auto match8 = [](int n)
{
    which++;
    constexpr auto bs2 = retLbdCase([](){
        using S = struct{
            ...
            constexpr auto getarr() {return array{
                ...
                Case<int, int>{1  + 20, 19 + 10},
                Case<int, int>{2  + 20, 18 + 10},
                Case<int, int>{3  + 20, 17 + 10},
                Case<int, int>{4  + 20, 16 + 10},
                Case<int, int>{6  + 20, 15 + 10},
                Case<int, int>{8  + 20, 14 + 10},
                Case<int, int>{10 + 20, 13 + 10},
                Case<int, int>{13 + 20, 12 + 10},
                Case<int, int>{16 + 20, 11 + 10},
                Case<int, int>{19 + 20, 10 + 10},
                
                Case<int, int>{1  + 40, 19 + 20},
                Case<int, int>{2  + 40, 18 + 20},
                Case<int, int>{3  + 40, 17 + 20},
                Case<int, int>{4  + 40, 16 + 20},
                Case<int, int>{6  + 40, 15 + 20},
                Case<int, int>{8  + 40, 14 + 20},
                Case<int, int>{10 + 40, 13 + 20},
                Case<int, int>{13 + 40, 12 + 20},
                Case<int, int>{16 + 40, 11 + 20},
                Case<int, int>{19 + 40, 10 + 20},
                
                Case<int, int>{1  + 60, 19 + 30},
                Case<int, int>{2  + 60, 18 + 30},
                Case<int, int>{3  + 60, 17 + 30},
                Case<int, int>{4  + 60, 16 + 30},
                Case<int, int>{6  + 60, 15 + 30},
                Case<int, int>{8  + 60, 14 + 30},
                Case<int, int>{10 + 60, 13 + 30},
                Case<int, int>{13 + 60, 12 + 30},
                Case<int, int>{16 + 60, 11 + 30},
                Case<int, int>{19 + 60, 10 + 30},
                
                Case<int, int>{1  + 80, 19 + 40},
                Case<int, int>{2  + 80, 18 + 40},
                Case<int, int>{3  + 80, 17 + 40},
                Case<int, int>{4  + 80, 16 + 40},
                Case<int, int>{6  + 80, 15 + 40},
                Case<int, int>{8  + 80, 14 + 40},
                Case<int, int>{10 + 80, 13 + 40},
                Case<int, int>{13 + 80, 12 + 40},
                Case<int, int>{16 + 80, 11 + 40},
                Case<int, int>{19 + 80, 10 + 40},
...
const auto add8(const size_t circle, int n)
{
    const auto timeBegin = boost::timer();
    uint64_t ret = 0;
    for (size_t i = 0; i < circle; ++i)
...
int main(int argc,char* argv[])
{
    ...
    for (int i = 0; i < 100; i++) {
        ...
        const auto [ret8, time8] = add8(CIRCLE, i);
        times[0] += time0;
        times[1] += time1;
        times[2] += time2;
        times[3] += time3;
        ...
        cout << "    结果8:" << ret8 << "    耗时8:" << time8 << "ms" << endl;
    }
